...
//     return c
// }
// let result1 = add(20, 40);
// let result2 = add(20,49);
...
//     ]
// }
// let i = prompt("Nhập yêu cầu")
// console.log(hits[1].[i])
...
// let {debug, ...remaining} = dictionary;

// console.log(remaining)
// console.log(debug)

// function getValue() {
//     let userChoice = prompt("Can u pick a keyword");
//     let result = dictionary[userChoice];
//     if (result === undefined) {
//         alert("Invalid key");
//     } else {
//         alert(result);
...
// let color = ["blue", "red", "yellow", "green", "black"];
// console.log(color[0]);
// console.log(color[2]);
...
// person.IQ = Math.floor(Math.random() * 80) + 120;
// console.log(person);
